...
public class Constants {
    ...
    public static final double PRICE_CALL_MIN = 0.1;

    public static final double PRODUCT_PRICE = 10;
    ...
    public static final String MESSAGE_CALLBACK_URL = "https://tpmsservice.herokuapp.com/api/v1/message/callback";
    public static final String MESSAGE_WEBHOOK = "https://tpmsreact.uptind.com/message";
