...
public class AppConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        JwtWebSecurityConfigurer
                ...
                .configure(http)
                .authorizeRequests()
                .antMatchers("/api/v1/call/events").permitAll()
                .antMatchers("/api/v1/call/dial").permitAll()
                .antMatchers("/api/v1/call/leave-message").permitAll()
                .antMatchers("/api/v1/call/handle-recording").permitAll()
                .antMatchers("/api/v1/call/record-event").permitAll()
                .antMatchers("/api/v1/call/receive-message").permitAll()
