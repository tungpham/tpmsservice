...
public class ResourceCall {
    ...
    public ResourceCall(List<CallDTO> records, String incomingFirstPageUri, String incomingNextPageUri, String incomingPreviousPageUri, String incomingUri, String outgoingFirstPageUri, String outgoingNextPageUri, String outgoingPreviousPageUri, String outgoingUri, int pageSize) {
